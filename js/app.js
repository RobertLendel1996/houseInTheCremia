    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                ...
                if (bodyLockStatus && e.target.closest(".menu__text")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("menu-open");
                }
            }));
        ...
        function documentActions() {
            ...
            if (furniture && !isMobile.any()) {
                ...
                function setMouseGalleryStyle() {
                    ...
                    let position = furnitureDifferent / 1e3 * positionX;
            ...
            let benefits = document.querySelectorAll(".benefits__item");
            benefits.forEach((benefits => {
                benefits.addEventListener("click", (function(e) {
                    benefits.classList.toggle("_open");
                }));
            }));
